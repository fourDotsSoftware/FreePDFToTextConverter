...
namespace FreePDFToTextConverter
{
    class Module
    {
        public static string ApplicationTitle = "Free PDF To Text Converter 4dots V1.0 - 4dots Software";
        public static string ShortApplicationTitle = "Free PDF To Text Converter 4dots V1.0";
        ...
        public static string UserDocumentsFolder = System.Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\PDF To Text Converter Documents";
